-- Misafir hesaplar: random e-posta ile oluşturulur, şahsi hesaba dönüştürülebilir
...
begin
  ...
  insert into public.profiles (id, username, full_name, birth_date, policy_consents, is_guest)
  values (
    new.id,
    final_username,
