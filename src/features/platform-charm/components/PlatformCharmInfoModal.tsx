...
import { PLATFORM_CHARM_NOTE } from '@/features/platform-charm/constants';
...
type PlatformCharmInfoModalProps = {
  visible: boolean;
  onClose: () => void;
...
export function PlatformCharmInfoModal({ visible, onClose, earnedAt, gender }: PlatformCharmInfoModalProps) {
        ...
        >
          ...
          >
            <View style={[styles.heroIcon, { borderColor: `${theme.rim}88` }]}>
              <PlatformCharmBadgeSvg size={40} gender={gender} />
            </View>
